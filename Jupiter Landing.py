...
def main():
    ...
    planet_high_low_image = pygame.image.load("planet_high_low.png").convert()
    planet_high_mid_image = pygame.image.load("planet_high_mid.png").convert()
    planet_low_high_image = pygame.image.load("planet_low_high.png").convert()
    planet_low_mid_image = pygame.image.load("planet_low_mid.png").convert()
    planet_mid_image = pygame.image.load("planet_mid.png").convert()
    planet_mid_high_image = pygame.image.load("planet_mid_high.png").convert()
    planet_mid_low_image = pygame.image.load("planet_mid_low.png").convert()
    planet_blank_image = pygame.image.load("planet_blank.png").convert()
    planet_landing_block_image = pygame.image.load("planet_landing_block.png").convert()
    ...
    boost_image = pygame.image.load("boost_lander.png").convert()
    exploded_lander_image = pygame.image.load("exploded_lander.png").convert()
    ...
    planet_dict = setup_planet(landing_blocks, planet_images)
    terrain = planet_dict['Terrain Blocks']
    terrain_y  = planet_dict['Terrain Blocks Y Coords']
    terrain_name = planet_dict['Terrain Blocks Names']
    ...
    while True: # main game loop
        ...
        for event in pygame.event.get():
            ...
            if key_pressed[pygame.K_RETURN]:
                ...
                terrain = planet_dict['Terrain Blocks']
                terrain_y  = planet_dict['Terrain Blocks Y Coords']
                tarrain_name = planet_dict['Terrain Blocks Names']
                lander_center_x = planet_dict['Lander Start X']
                terrain_blocks = planet_dict['Number Terrain Blocks']
                landing_pad_block = planet_dict['Landing Pad']
        ...
        if hit_terrain is True:
            ...
            score_text = "Your overall score is " + str(new_score)
            ...
            text = font.render(return_message_text, True, (GREEN))
            text_rect = text.get_rect()
...
def setup_planet(landing_blocks, planet_images):
    ...
    planet_dict = {'Terrain Blocks': terrain, 'Terrain Blocks Y Coords': terrain_y, 'Terrain Blocks Names': terrain_name, 'Lander Start X': lander_center_x, 'Number Terrain Blocks': terrain_blocks, 'Landing Pad': landing_pad_block}
    return planet_dict
